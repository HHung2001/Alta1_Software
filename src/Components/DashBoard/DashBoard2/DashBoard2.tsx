...
import TopMenu from '../../DashBoard/TopMenuBar/TopMenu'
                ...
                <div className={classes.Pic6}>
                    ...
                    <div className={classes.Combobox2}>
                        <select 
                            ...
                            <option  id='default'value="/DashBoardTrang2">Ngày</option>
                            <option value="/DashBoard">Tuần</option>
                            <option value="/DashBoard3">Tháng</option>
                        ...
                        <div>
                          <span className={classes.Gray}></span>
                              <div className={classes.DetailText2}>
                                  <Link to='/ThietBi'><label>Đang hoạt động</label></Link>
                              </div>
                    ...
                    <div className={classes.DetailEqui7}>
                        ...
                        <div>
                          <span className={classes.Blue}></span>
                              <div className={classes.DetailText2}>
                                  <Link to='/DV'><label>Đang hoạt động</label></Link>
                              </div>
                    ...
                    <div className={classes.DetailEqui8}>
                        ...
                        <div>
                          <span className={classes.XanhLa}></span>
                              <div className={classes.DetailText2}>
                                  <Link to='/CapSoDS'><label>Đã sử dụng</label></Link>
                              </div>
